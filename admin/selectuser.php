...
<a href="hoc.php">
<div class="col-sm-4 text-center" style="font-size: 20px; padding: 40px; background:#333333; color: white; " ><span class="glyphicon glyphicon-list-alt"></span> &nbsp;&nbsp;  Manage HOC</div></a>
<div class="col-sm-1"></div>  
            <a href="ec.php">
<div class="col-sm-4 text-center" style="font-size: 20px; padding: 40px; background:#333333; color: white; " ><span class="glyphicon glyphicon-list-alt"></span> &nbsp;&nbsp;  Manage EC</div></a>
