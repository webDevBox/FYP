...
<head>
  <title>Student Panel - Global FYP</title>
  <meta charset="utf-8" />
...
<div class="nav-bar">
  <div class="container">
    <div class="row">
      <div class="col-sm-4">
        <div class="logo1">
          <a href="index.html"><img height="43" width="191" src="..\images/logo1.png" alt="logo1"></a>
        </div>
      </div>
      <div class="col-sm-8">
        <div class="row">
           <div class="col-sm-3">
            <div class="info-nav">
              ...
              <div class="info-nav-dtl"><a href="tel:#">042-3594281</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Email Address:</div>
              <div class="info-nav-dtl"><a href="mailto:#">info@FYPPortal.com</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Contact</div>
              <div class="info-nav-dtl">COMSATS University Islamabad</div>
            </div>
          </div>
          <div class="col-sm-3">
