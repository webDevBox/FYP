      ...
      <div id="content">
        ...
        <!-- /.container-fluid -->
	            ...
	            <table class="table table-striped" id="dataTable" width="100%" >
                  <h4 class="text-center btn btn-success btn-block btn-user btn-block"> FYP Students Information </h4>
				  <thead>
				  ...
				  <tbody>
			       ...
			       ?>
					<tr class="table">
                      ...
                      <td><a href="delete/delete_student.php?student_id=<?php echo $row['student_id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
					</tr>
                 <?php } ?>
				  </tbody><br>
				</table>
