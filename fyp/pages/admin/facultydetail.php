    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- /.container-fluid -->
                ...
                <h4 class="text-center btn btn-success btn-block btn-user btn-block">Faculty Members Information </h4>
				  <thead>
				  ...
				  <tbody>
			       ...
			       ?>
					<tr class="table">
                      ...
                      <td><a href="delete/delete_faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
					</tr>
                 <?php } ?>
				  </tbody><br>
				</table>
